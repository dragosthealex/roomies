    ...
    <div class="column-2">
      <div class="column-box">
        ...
        <div class="box-padding">
          ...
          </div><label for="pressEnterToSend"><input type="checkbox" id="pressEnterToSend" onchange="var b=this.parentNode.nextSibling,c=b.className;b.className=this.checked?c+'hidden ':c.replace(' hidden ', ' ')" checked> Press Enter to send</label><input type="submit" class="input-button block hidden" value="Send"
