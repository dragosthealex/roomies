      ...
      <div class="box-padding"> 
        <h2 class = "h2"> Disclaimer </h2>
          <p class = "text">
            ...
            The information is provided by <b>findRoomies</b> and while we endeavour to keep the 
          ...
          <p class="text">          
            ...
            control of <b>findRoomies</b>. We have no control over the nature, content and 
          ...
          <p class="text">          
            ...
            <b>findRoomies</b> takes no responsibility for, and will not be liable for, the 
            website being temporarily unavailable due to technical issues beyond our control.</p>
          <p class="text">          
