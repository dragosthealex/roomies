  ...
  <div class="box-padding">
    ...
    <section>
      ...
      <p class="text">
        ...
        <a href="http://www.google.com/privacy.html" class="link" target="_blank">
    ...
    <section>
      ...
      <p class="text">
        This website and its owners use any information submitted to provide you with further information about the products / services to offer or to assist you in answering any questions or queries you may have submitted. This includes using your details to subscribe you to any email newsletter program the website operates but only if this was made clear to you and your express permission was granted when submitting any form to email process. Or whereby you the consumer have previously purchased from or enquired about purchasing from the company a product or service that the email newsletter relates to. This is by no means an entire list of your user rights in regard to receiving email marketing material. Your details are not passed on to any third parties.
      </p>
    </section>
    ...
    <section>
      ...
      <p class="text">
        ...
        <a href="http://bit.ly/zyVUBo" class="link" target="_blank">http://bit.ly/zyVUBo</a>).
      </p>
      <p class="text">
