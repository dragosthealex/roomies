...
<div class="box">
	<ul class="box-padding footer">
		...
		<li class="footer-item"><a href="/inc/html/about.php" class="footer-link">About</a></li>
		<li class="footer-item"><a href="/inc/html/Terms.php" class="footer-link">Terms</a></li>
		<li class="footer-item"><a href="#" class="footer-link">Privacy</a></li>
        <li class="footer-item"><a href="/inc/html/disclaimer.php" class="footer-link">Disclaimer</a></li>
