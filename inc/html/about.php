  ...
  <div class="column-2">
    <div class="column-box">
      <div class="box-padding"> 
        ...
        <p class = "text">
          findRoomies is a room-mate matching website and service that is primarily aimed at 
          ...
          (under the UK law) and every user has the freedom to
          decide which information to share or not share other than the mandatory details which 
          include:
          <ul>
